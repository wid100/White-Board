                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="meta_title"
                                            ...
                                            type="text" value="{{ old('meta_title', $post->meta_title) }}"
                                            maxlength="70">
                                        @error('meta_title')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input name="meta_tag" id="tags"
                                            ...
                                            value="{{ old('meta_tag', json_decode($post->meta_tag)) }}"
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="meta_description" id="description" rows="5"
                                            class="form-control @error('meta_description') is-invalid @enderror" maxlength="170">{{ old('meta_description', $post->meta_description) }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="post_type" class="form-control @error('post_type') is-invalid @enderror"
                                            ...
                                            value="{{ old('post_type', $post->post_type) }}">
                                        @error('post_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <select id="issue_id" name="issue_id"
                                            ...
                                            @foreach ($issues as $issue)
                                                <option value="{{ $issue->id }}"
                                                    {{ old('issue_id', $post->issue_id) == $issue->id ? 'selected' : '' }}>
                                                    {{ $issue->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input id="post_date"
                                            ...
                                            type="date"
                                            value="{{ old('post_date', optional($post->post_date)->format('Y-m-d')) }}">
                                        @error('post_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="open-source-plugins" name="description"
                                            class="form-control @error('description') is-invalid @enderror" cols="30" rows="5">{{ old('description', $post->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            ...
                                            <input type="checkbox" class="form-check-input"
                                                {{ old('status', $post->status) ? 'checked' : '' }} name="status"
                                                id="termsCheck">
                                        </div>
                                    </div>
                                </div>
